...
public class GenericDaoTests {
    ...
    public void getTest() {
        ...
        Trainee trainee = traineeDao.get(1);
        Trainer trainer = trainerDao.get(2);
        Training training = trainingDao.get(3);
    ...
    public void addTest() {
        ...
        training.setTrainingName("Beginners");
        training.setId(6);
        Training training1 = trainingDao.addTraining(training);
        Trainer trainer1 = trainerDao.add(trainer);
